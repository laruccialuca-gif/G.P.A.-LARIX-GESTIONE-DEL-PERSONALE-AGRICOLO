    ...
    <div className="attendance-page">
      ...
      {loading ? (
        ...
        <AttendanceTable
          ...
          getMainTypeMeta={getMainTypeMeta}
          getDisplayedInputValue={getDisplayedInputValue}
          getMainInputValue={getMainInputValue}
          getAttendanceHoursTone={getAttendanceHoursTone}
          selectAllInputText={selectAllInputText}
          getCalendarHeaderStyle={getCalendarHeaderStyle}
