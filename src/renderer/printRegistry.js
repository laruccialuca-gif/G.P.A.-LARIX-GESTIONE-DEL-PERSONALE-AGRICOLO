export const PRINT_CATEGORIES = [
  {
    ...
    types: [
      ...
      {
        id: 'attendance-team-headcount',
        label: 'Stampa presenze per squadra - numero presenti',
        status: 'ready',
        filters: ['year', 'month', 'teamId'],
        employeeSelection: 'none',
      },
      {
        id: 'attendance-team-table',
        label: 'Stampa presenze per squadra - tabella presenze',
        status: 'ready',
        filters: ['year', 'month', 'teamId'],
        employeeSelection: 'none',
      },
      {
        id: 'attendance-team-weekly-signatures',
        label: 'Firme settimanali',
        status: 'ready',
        filters: ['year', 'month', 'teamId', 'dateFrom', 'dateTo'],
        employeeSelection: 'none',
      },
      {
  ...
  },
  {
    ...
    types: [
      ...
      {
        id: 'payroll-selected-days-month',
        label: 'Date inserite busta paga',
        status: 'ready',
        filters: ['year', 'month', 'teamId'],
        employeeSelection: 'multiple_optional',
      },
